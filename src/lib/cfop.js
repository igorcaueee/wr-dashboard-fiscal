// Descrições oficiais dos CFOPs (Código Fiscal de Operações e Prestações),
// conforme tabela do Ajuste SINIEF 07/2005 e atualizações posteriores.
const CFOP_DESC = {
  ...
  '1931': 'Lançamento pelo tomador do serviço de transporte quando a responsabilidade de retenção do imposto for atribuída ao remetente ou alienante da mercadoria',
  ...
  '2931': 'Lançamento pelo tomador do serviço de transporte quando a responsabilidade de retenção do imposto for atribuída ao remetente ou alienante da mercadoria',
  ...
  '5929': 'Lançamento em decorrência de emissão de documento fiscal relativo a operação também registrada em ECF',
  '5931': 'Lançamento em decorrência da responsabilidade de retenção do imposto por substituição tributária, atribuída ao remetente ou alienante da mercadoria',
  ...
  '6929': 'Lançamento em decorrência de emissão de documento fiscal relativo a operação também registrada em ECF',
  '6931': 'Lançamento em decorrência da responsabilidade de retenção do imposto por substituição tributária, atribuída ao remetente ou alienante da mercadoria',
