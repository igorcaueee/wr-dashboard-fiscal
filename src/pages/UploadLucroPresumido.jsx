...
4. Se o débito de PIS/COFINS declarado for muito menor do que 0,65%/3% sobre o total de vendas de mercadorias, NÃO assuma automaticamente que há erro de cálculo: pode haver receitas sujeitas a CST de alíquota zero, monofásica ou substituição tributária (comum, por ex., em cosméticos, autopeças e bebidas), que legalmente não compõem a base padrão de PIS/COFINS. Só aponte inconsistência se os valores informados (débito x base x alíquota padrão) forem incompatíveis entre si — nunca por comparação direta com o faturamento total sem considerar possíveis exclusões de base.
